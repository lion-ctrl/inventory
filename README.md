...
Production port of the high-fidelity HTML prototype in `designs/` (see
`designs/README.md` and `IMPLEMENTATION_PLAN.md`). All UI text is Spanish; design
tokens and styles are ported verbatim from the prototype.
